package sharon.com.nytimessearch;
...
import static sharon.com.nytimessearch.R.id.ivImage;

/**
 * Created by sharonwang on 2017/2/22.
 */
...
public class ArticleArrayAdapter extends ArrayAdapter <Article> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Log.d("DEBUG", tvTitle.getText().toString());
